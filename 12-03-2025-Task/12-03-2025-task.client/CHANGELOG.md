...
- Create Angular project with ng: `ng new 12-03-2025-task.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`12-03-2025-task.client.esproj`).
